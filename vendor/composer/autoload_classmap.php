...
return array(
    'Aether' => $baseDir . '/src/Aether.php',
    'AetherActionResponse' => $baseDir . '/src/AetherActionResponse.php',
    'AetherCLI' => $baseDir . '/src/AetherCLI.php',
    'AetherCLITest' => $baseDir . '/tests/CLITest.php',
    'AetherCache' => $baseDir . '/src/AetherCache.php',
    'AetherCacheMemcache' => $baseDir . '/src/AetherCacheMemcache.php',
    'AetherConfig' => $baseDir . '/src/AetherConfig.php',
    'AetherConfigErrorException' => $baseDir . '/src/AetherExceptions.php',
    'AetherConfigTest' => $baseDir . '/tests/ConfigTest.php',
    'AetherException' => $baseDir . '/src/AetherExceptions.php',
    'AetherFinalRuleFoundException' => $baseDir . '/src/AetherExceptions.php',
    'AetherFragmentResponse' => $baseDir . '/src/AetherFragmentResponse.php',
    'AetherInvalidModuleNameException' => $baseDir . '/src/AetherExceptions.php',
    'AetherJSONCommentFilteredResponse' => $baseDir . '/src/AetherJSONCommentFilteredResponse.php',
    'AetherJSONPResponse' => $baseDir . '/src/AetherJSONPResponse.php',
    'AetherJSONResponse' => $baseDir . '/src/AetherJSONResponse.php',
    'AetherJsonCommentFilteredResponseTest' => $baseDir . '/tests/JsonCommentFilteredResponseTest.php',
    'AetherJsonResponseTest' => $baseDir . '/tests/JsonResponseTest.php',
    'AetherMissingFileException' => $baseDir . '/src/AetherExceptions.php',
    'AetherModule' => $baseDir . '/src/AetherModule.php',
    'AetherModuleFactory' => $baseDir . '/src/AetherModuleFactory.php',
    'AetherModuleFactoryTest' => $baseDir . '/tests/ModuleFactoryTest.php',
    'AetherModuleHeader' => $baseDir . '/src/AetherModuleHeader.php',
    'AetherModuleNotFoundException' => $baseDir . '/src/AetherExceptions.php',
    'AetherNoUrlRuleMatchException' => $baseDir . '/src/AetherExceptions.php',
    'AetherRedirectException' => $baseDir . '/src/AetherRedirectException.php',
    'AetherResponse' => $baseDir . '/src/AetherResponse.php',
    'AetherSection' => $baseDir . '/src/AetherSection.php',
    'AetherSectionFactory' => $baseDir . '/src/AetherSectionFactory.php',
    'AetherSectionFactoryTest' => $baseDir . '/tests/SectionFactoryTest.php',
    'AetherSectionTest' => $baseDir . '/tests/SectionTest.php',
    'AetherServiceLocator' => $baseDir . '/src/AetherServiceLocator.php',
    'AetherServiceLocatorTest' => $baseDir . '/tests/ServiceLocatorTest.php',
    'AetherServiceNotFoundException' => $baseDir . '/src/AetherExceptions.php',
    'AetherTemplate' => $baseDir . '/src/templating/AetherTemplate.php',
    'AetherTemplateSmarty' => $baseDir . '/src/templating/AetherTemplateSmarty.php',
    'AetherTemplateTest' => $baseDir . '/tests/templating/TemplateTest.php',
    'AetherTextResponse' => $baseDir . '/src/AetherTextResponse.php',
    'AetherTimer' => $baseDir . '/src/AetherTimer.php',
    'AetherUrlParser' => $baseDir . '/src/AetherUrlParser.php',
    'AetherUrlParserTest' => $baseDir . '/tests/UrlParserTest.php',
    'AetherVector' => $baseDir . '/src/AetherVector.php',
    'AetherXMLResponse' => $baseDir . '/src/AetherXMLResponse.php',
    'File_Iterator' => $vendorDir . '/phpunit/php-file-iterator/src/Iterator.php',
    'File_Iterator_Facade' => $vendorDir . '/phpunit/php-file-iterator/src/Facade.php',
    'File_Iterator_Factory' => $vendorDir . '/phpunit/php-file-iterator/src/Factory.php',
    'Hellolocal' => $baseDir . '/tests/fixtures/modules/Hellolocal.php',
    'NotFoundSection' => $baseDir . '/tests/fixtures/sections/NotFoundSection.php',
    ...
    'TestCLIApp' => $baseDir . '/tests/CLITest.php',
    'TestCLIApp2' => $baseDir . '/tests/CLITest.php',
    'Testsection' => $baseDir . '/tests/fixtures/sections/Testsection.php',
